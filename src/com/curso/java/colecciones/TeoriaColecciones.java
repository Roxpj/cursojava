...
public class TeoriaColecciones {
	...
	public static void main(String[] args) {
		...
		///List
		////Permite guardar por posición y objetos duplicados
		//Clase ArrayList, implementa la interfaz List
		//Clase LinkedList

		///Set
		////Guarda los objetos automáticamente, sin posiciones
		////No permite guardar el mismo objeto más de una vez
		//Clase HashSet
		...
		//--Ver DiferenciaTiempoColecciones--
